...
namespace LiteDB.Shell
{
    public class Display
    {
        ...
        public void WriteWelcome()
        {
            ...
            this.WriteInfo("this is changed update by TNet 4");
            this.WriteInfo("Getting started with `help`, `help full` or `help <command>`");
			  this.WriteInfo("tcp listen in 0.0.0.0:5317`");
			   this.WriteInfo("you can send \"set|value_name|value_value \" to this tcp");
            this.WriteInfo("");
        }
